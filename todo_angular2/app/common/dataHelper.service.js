System.register(["angular2/core", "rxjs/Observable"], function(exports_1, context_1) {
    ...
    var STATUS_OK, STATUS_KO, DataHelperService;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            ...
            DataHelperService = (function () {
                ...
                DataHelperService.prototype.handleResponseError = function (error) {
                    console.error(error);
            ...
            exports_1("DataHelperService", DataHelperService);
        }
    }
});
